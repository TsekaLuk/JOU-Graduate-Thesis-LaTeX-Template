...
输出：
- docs/assets/graduate-cover-overlay.png
- docs/assets/graduate-cover-overlay-focus.png
- docs/assets/graduate-cover-diff.png
- docs/assets/graduate-cover-diff-focus.png
- docs/assets/graduate-cover-checker.png
- docs/assets/graduate-cover-checker-focus.png
"""
...
def main() -> int:
    ...
    reference_page = render_page(REFERENCE_PDF, 1, TEMP_DIR / "graduate-cover-ref")
    current_page = render_page(CURRENT_PDF, 1, TEMP_DIR / "graduate-cover-cur")
    ...
    overlay_path = ASSET_DIR / "graduate-cover-overlay.png"
    diff_path = ASSET_DIR / "graduate-cover-diff.png"
    checker_path = ASSET_DIR / "graduate-cover-checker.png"
    overlay_focus_path = ASSET_DIR / "graduate-cover-overlay-focus.png"
    diff_focus_path = ASSET_DIR / "graduate-cover-diff-focus.png"
    checker_focus_path = ASSET_DIR / "graduate-cover-checker-focus.png"
